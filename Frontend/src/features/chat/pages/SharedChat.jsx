...
const SharedChat = () => {
    ...
    if (loading) {
        return (
            <main className="min-h-screen w-full bg-[#07090f] flex items-center justify-center">
                <div className="flex flex-col items-center gap-3 text-white/30">
                    <div className="h-6 w-6 animate-spin rounded-full border-2 border-white/20 border-t-[#31b8c6]" />
    ...
    if (error) {
        ...
        return (
            <main className="min-h-screen w-full bg-[#07090f] flex items-center justify-center p-6">
                <div className="flex flex-col items-center gap-4 text-center max-w-sm">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/5 border border-white/10">
                        <AlertCircle size={26} className={isExpired ? "text-yellow-400" : "text-red-400"} />
                    </div>
    ...
    return (
        <main className="min-h-screen w-full bg-[#07090f] text-white">
            ...
            {/* Header */}
            <header className="sticky top-0 z-10 border-b border-white/5 bg-[#07090f]/90 backdrop-blur-sm px-4 py-3">
                <div className="mx-auto flex max-w-3xl items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="hidden sm:block text-sm text-white/40">Shared Chat</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link
                            to="/"
                            className="flex items-center gap-1.5 rounded-xl border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-white/50 hover:text-[#31b8c6] hover:border-[#31b8c6]/30 transition"
                        >
                            Open Cognivra
            ...
            <div className="mx-auto max-w-3xl px-4 py-8">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        {chatData?.model && (
                            <span className="text-xs text-white/30 capitalize border border-white/10 rounded-full px-2.5 py-0.5">
                                {chatData.model}
                            </span>
                        )}
